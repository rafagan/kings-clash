...
void vert (inout appdata_full v, out Input o) {
		...
		#else
			o._uv_Relief.xy=mul(unity_ObjectToWorld, v.vertex).xz /  _TERRAIN_ReliefTransformTriplanarZ;
		#endif
	#else
...
//			#else
				o.lightDir.xyz = mul (rotation, mul(unity_WorldToObject, float4(0,1,0,0)).xyz);
//			#endif
		#else
			#ifdef APPROX_TANGENTS
