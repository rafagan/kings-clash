...
public class UITooltip : MonoBehaviour {
    ...
    void SetText(string tooltipText) {
        if (text != null && !string.IsNullOrEmpty(tooltipText)) {
            ...
            if (background != null) {
                ...
                background.height = Mathf.RoundToInt(mSize.y+20);
            }

            if (UICamera.mainCamera.transform.GetComponent<UICamera>() != null) {
                ...
                float activeSize = UICamera.mainCamera.orthographicSize / mTrans.parent.lossyScale.y;
                ...
                mTrans.position = UICamera.mainCamera.ViewportToWorldPoint(mPos);
                mPos = mTrans.localPosition;
    ...
    static public void ShowText(string tooltipText) {
        if (mInstance != null) {
            mInstance.background.width = 1;
            mInstance.background.height = 1;
